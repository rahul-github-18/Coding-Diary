...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-[#0f172a] via-[#1e1e38] to-[#0b0f19] p-4 font-sans select-none relative overflow-hidden">
      ...
      {/* Outer Row Container */}
      <div className="flex flex-col lg:flex-row items-center justify-between w-full max-w-[1000px] gap-12 z-10 px-4">
